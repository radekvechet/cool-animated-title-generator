  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className={`absolute inset-y-0 right-0 w-80 bg-gray-950 border-l border-gray-800 shadow-2xl transition-transform duration-500 transform ${isDrawerOpen ? 'translate-x-0' : 'translate-x-full'} flex flex-col`}
        >
